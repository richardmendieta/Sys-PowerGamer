...
//        $("#total_cobro").val("");
//        $("#total_cobro").focus();
//        $("#mensajes").html("Monto no puede ser menos al Total.");
//    } else {
//        if (monto === "") {
//            $("#vuelto").val("0");
//            $("#monto").focus();
...
function validarFormularioVenta() {
    ...
    if ($("#cantidad_productoventa").val() === "0") {
        valor = false;
    ...
    if ($("#stock_producto").val() < $("#cantidad_productoventa").val()) {
        valor = false;
